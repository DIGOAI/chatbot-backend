...
class Context():
    ...
    def __init__(self, event: Event, client: Client | None, last_state: str | None, conversation: Conversation) -> None:
    ...
    def __str__(self) -> str:
        return f"Context(event_twilio={self.event_twilio}, client={self.client}, conversation={self.conversation}, last_state={self.last_state})"
